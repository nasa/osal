...
*/
UT_DEFAULT_STUB(OS_TimeBaseCreate_Impl, (const OS_object_token_t *token))
UT_DEFAULT_STUB(OS_TimeBaseSet_Impl, (const OS_object_token_t *token, uint32 start_time, uint32 interval_time))
UT_DEFAULT_STUB(OS_TimeBaseDelete_Impl, (const OS_object_token_t *token))
...
UT_DEFAULT_STUB(OS_TimeBaseGetInfo_Impl, (const OS_object_token_t *token, OS_timebase_prop_t *timer_prop))
