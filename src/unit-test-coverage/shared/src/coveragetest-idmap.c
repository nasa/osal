...
void Test_OS_ForEachObject(void)
{
    ...
    UtAssert_True(Count.TaskCount == 1, "OS_ForEachObjectOfType(), creator %08lx TaskCount (%lu) == 1", (unsigned long)self_id.val, (unsigned long)Count.TaskCount);
